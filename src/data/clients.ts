  ...
  technical: [
    ...
    },
    {
      ...
      body: [
        ...
        "PostHog is being added now for product analytics — page views and key actions like sign-in and bookings. It runs client-side and is configured by env vars in Coolify (the PostHog project key and host), so it stays off in local dev unless those are set.",
      ],
    },
    {
